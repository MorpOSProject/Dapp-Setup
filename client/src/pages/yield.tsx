        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>{strategy.protocol || strategy.protocolId}</CardDescription>
            </div>
          </div>
          <Badge 
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-mono font-medium text-success flex items-center gap-1">
              <TrendingUp className="w-3 h-3" />
              {(strategy.apy || strategy.expectedApy || 0).toFixed(1)}%
            </p>
          </div>
          <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-success">
                      +{marinadeInfo.stats.stakingApy.toFixed(1)}% APY
                    </p>
                  </div>
                </div>
              </CardContent>
